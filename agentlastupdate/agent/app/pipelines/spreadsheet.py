"""
Purpose:
- Extracts structured summary/statistics from CSV/XLS/XLSX files.

Libraries used:
- pandas: reads spreadsheet files and computes table/null/numeric summaries.
- pathlib: file extension/type handling.
"""
