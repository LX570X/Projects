"""
Purpose:
- Extracts text from PDF/TXT/DOCX and analyzes embedded/scanned images when needed.

Libraries used:
- fitz (PyMuPDF): reads PDF text/images and renders pages.
- python-docx/zipfile/tempfile/shutil/pathlib: reads DOCX text and media files safely.
- app.pipelines.images: reuses image analysis for OCR/description.
"""
