"""
Purpose:
- FastAPI entrypoint for API-based file extraction endpoints.

Libraries used:
- fastapi: to expose HTTP endpoints and auto-generate API docs.
- app.routers.*: route modules for each file type.
"""
