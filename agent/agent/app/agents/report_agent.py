...
def generate_single_report(file_name: str, file_type: str, extraction_data: dict) -> SingleFileReport:
...
def generate_final_report(single_reports: list[dict]) -> FinalReport:
